...
namespace SendData
{
    public partial class Form1 : Form
    {
        ...
        private void MessageCallBack(IAsyncResult Res)
        {
            try
            {
                ...
                socket.BeginReceiveFrom(Buffer, 0, Buffer.Length, SocketFlags.None, ref Send, new AsyncCallback(MessageCallBack), Buffer);
            }
            catch (Exception ex)
            {
